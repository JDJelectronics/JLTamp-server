...
from .routers import auth, media, stream, artwork, playlists, libraries, admin_users, likes, uploads, history, stats, mix, session, importer, smart, lyrics, wishlist, artistinfo, popular
...
for r in (auth.router, media.router, stream.router, artwork.router,
          ...
          smart.router, lyrics.router, wishlist.router,
          artistinfo.router, popular.router):
